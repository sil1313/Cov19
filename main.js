...
module.exports = __webpack_require__(/*! /Users/silviamasllorens/CovidApp/src/main.ts */"zUnb");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-app>\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu contentId=\"main-content\" type=\"overlay\">\n      <ion-content>\n        <ion-list id=\"elements-menu\">\n        <ion-list-header>Vacunes a Catalunya</ion-list-header> \n\n        <ion-menu-toggle auto-hide=\"false\">\n        <ion-item routerDirection=\"root\" routerLink=\"home\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n        <ion-icon slot=\"start\" ios=\"analytics-outline\" md=\"analytics-outline\"></ion-icon>\n\n        <ion-label>Totals Vacunes</ion-label> \n      </ion-item>\n      <ion-item routerDirection=\"root\" routerLink=\"Pfizer\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n        <ion-icon slot=\"start\" ios=\"bandage-outline\" md=\"bandage-outline\"></ion-icon>\n\n        <ion-label>Pfizer Informació</ion-label> \n      </ion-item>\n\n    <ion-item routerDirection=\"root\" routerLink=\"janssen\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n      <ion-icon slot=\"start\" ios=\"bandage-outline\" md=\"bandage-outline\"></ion-icon>\n\n      <ion-label>Janssen Informació</ion-label> \n    </ion-item>\n  <ion-item routerDirection=\"root\" routerLink=\"lonza\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n    <ion-icon slot=\"start\" ios=\"bandage-outline\" md=\"bandage-outline\"></ion-icon>\n\n    <ion-label>Lonza Informació</ion-label> \n  </ion-item>\n  <ion-item routerDirection=\"root\" routerLink=\"astra-zeneca\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n    <ion-icon slot=\"start\" ios=\"bandage-outline\" md=\"bandage-outline\"></ion-icon>\n    <ion-label>Astra Zeneca Informació</ion-label> \n  </ion-item>\n\n  <ion-item routerDirection=\"root\" routerLink=\"noad\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n    <ion-icon slot=\"start\" ios=\"bandage-outline\" md=\"bandage-outline\"></ion-icon>\n    <ion-label>No Administrada</ion-label> \n  </ion-item>\n\n        </ion-menu-toggle>\n\n      </ion-list>\n     </ion-content>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n");
...
/* harmony import */ var _services_dades_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/dades.service */ "l0mX");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] }, _services_dades_service__WEBPACK_IMPORTED_MODULE_8__["DadesService"]],
...
/***/ "l0mX":
/*!*******************************************!*\
  !*** ./src/app/services/dades.service.ts ***!
  \*******************************************/
...
let DadesService = class DadesService {
    ...
    dadesTotals() {
        // és només un exemple, utilitzeu els punts de la api que vulgueu
    ...
    dadesVacunes() {
        // és només un exemple, utilitzeu els punts de la api que vulgueu
        const apiURL = "https://analisi.transparenciacatalunya.cat/resource/irki-p3c7.json";
        return this.http.get(apiURL);
    }
};
...
const routes = [
    ...
    {
        path: 'Pfizer',
        loadChildren: () => __webpack_require__.e(/*! import() | pfizer-pfizer-module */ "pfizer-pfizer-module").then(__webpack_require__.bind(null, /*! ./pfizer/pfizer.module */ "ru42")).then(m => m.PfizerPageModule)
    },
    {
        path: 'janssen',
        loadChildren: () => __webpack_require__.e(/*! import() | janssen-janssen-module */ "janssen-janssen-module").then(__webpack_require__.bind(null, /*! ./janssen/janssen.module */ "hxuI")).then(m => m.JanssenPageModule)
    },
    {
        path: 'lonza',
        loadChildren: () => __webpack_require__.e(/*! import() | lonza-lonza-module */ "lonza-lonza-module").then(__webpack_require__.bind(null, /*! ./lonza/lonza.module */ "67Nf")).then(m => m.LonzaPageModule)
    },
    {
        path: 'astra-zeneca',
        loadChildren: () => __webpack_require__.e(/*! import() | astra-zeneca-astra-zeneca-module */ "astra-zeneca-astra-zeneca-module").then(__webpack_require__.bind(null, /*! ./astra-zeneca/astra-zeneca.module */ "DQRa")).then(m => m.AstraZenecaPageModule)
    },
    {
        path: 'noad',
        loadChildren: () => __webpack_require__.e(/*! import() | noad-noad-module */ "noad-noad-module").then(__webpack_require__.bind(null, /*! ./noad/noad.module */ "ymJ5")).then(m => m.NoadPageModule)
    }
];
